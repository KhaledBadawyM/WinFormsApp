...
namespace DB1 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class usersDataTable : global::System.Data.TypedTableBase<usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public usersRow AddusersRow(int userId, string userName, string password, int privilege, int groupId) {
...
namespace DB1.Database1DataSet1TableAdapters {
    ...
    public partial class usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[users] WHERE (([userId] = @Original_userId) AND ((@IsNull_priv" +
                "ilege = 1 AND [privilege] IS NULL) OR ([privilege] = @Original_privilege)) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[users] ([userId], [userName], [password], [privilege], [groupI" +
                "d]) VALUES (@userId, @userName, @password, @privilege, @groupId);\r\nSELECT userId" +
                ", userName, password, privilege, groupId FROM users WHERE (userId = @userId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[users] SET [userId] = @userId, [userName] = @userName, [password] = @password, [privilege] = @privilege, [groupId] = @groupId WHERE (([userId] = @Original_userId) AND ((@IsNull_privilege = 1 AND [privilege] IS NULL) OR ([privilege] = @Original_privilege)) AND ([groupId] = @Original_groupId));
SELECT userId, userName, password, privilege, groupId FROM users WHERE (userId = @userId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT userId, userName, password, privilege, groupId FROM dbo.users";
        ...
        public virtual int Delete(int Original_userId, global::System.Nullable<int> Original_privilege, int Original_groupId) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_userId));
            if ((Original_privilege.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_privilege.Value));
            }
            else {
        ...
        public virtual int Insert(int userId, string userName, string password, global::System.Nullable<int> privilege, int groupId) {
        ...
        public virtual int Update(int userId, string userName, string password, global::System.Nullable<int> privilege, int groupId, int Original_userId, global::System.Nullable<int> Original_privilege, int Original_groupId) {
            ...
            if ((Original_privilege.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_privilege.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userName, string password, global::System.Nullable<int> privilege, int groupId, int Original_userId, global::System.Nullable<int> Original_privilege, int Original_groupId) {
            return this.Update(Original_userId, userName, password, privilege, groupId, Original_userId, Original_privilege, Original_groupId);
        }
    }
